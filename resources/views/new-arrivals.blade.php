        ...
        <div class="px-8 py-12">
            ...
            <div class="flex justify-center gap-14 mb-14 flex-wrap">
                ...
                <a href="{{ route('new.arrivals') }}" class="flex flex-col items-center group cursor-pointer">
                    ...
                    <span class="mt-3 text-pink-500 text-sm font-semibold">New Arrivals</span>
                </a>
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-1">Produk yang baru ditambahkan dalam 7 hari terakhir</p>
                </div>
            ...
            <div class="flex flex-col items-center justify-center py-24 text-gray-400">
                ...
                <p class="text-lg font-medium">Belum ada produk baru minggu ini.</p>
                <p class="text-sm mt-1">Pantau terus, produk baru akan segera hadir!</p>
                ...
                <div class="grid gap-6" style="grid-template-columns: repeat(6, minmax(260px, 260px));">
                    ...
                    <a href="{{ route('product.show', $product->id) }}" class="block">
                        <div
                            ...
                            {{-- Tanggal ditambahkan --}}
                            <div class="text-gray-300 text-xs mt-1 text-center">
            ...
            <div class="mt-8 text-center text-gray-400 text-sm">
                Menampilkan {{ $products->count() }} produk baru dalam 7 hari terakhir
            </div>
