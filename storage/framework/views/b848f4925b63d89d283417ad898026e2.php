...
<header class="w-full bg-white shadow-md px-8 py-4 flex items-center justify-between">
    ...
    transition duration-200 z-50">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center px-4 py-2 hover:bg-pink-50">
                    🏠 Home
                </a>
    ...
    <div class="flex items-center space-x-6">
        ...
        <?php if(auth()->guard()->guest()): ?>
        <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700">
            LOG IN /
...
</header><?php /**PATH C:\laragon\www\PPL\resources\views/components/header.blade.php ENDPATH**/ ?>